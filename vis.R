...
#' @export
vis.immunr_homeo <- function(.data, .by = NA, .meta = NA, .errorbars = c(0.025, 0.975), .errorbars.off = FALSE, .stack = NA, .test = TRUE, .points = TRUE, .sort = FALSE, .x_axis_adjust = FALSE,  .x_axis_reorder = FALSE,...) {
  ...
  p <- vis_bar(melted,
    .by = .by, .meta = .meta,  .sort = .sort, .x_axis_adjust = .x_axis_adjust, .x_axis_reorder = .x_axis_reorder,
...
#' @export
vis.immunr_top_prop <- function(.data, .by = NA, .meta = NA, .errorbars = c(0.025, 0.975), .errorbars.off = FALSE, .stack = NA, .points = TRUE, .test = TRUE, .sort = FALSE, .x_axis_adjust = FALSE, .x_axis_reorder = FALSE, ...) {
...
#' @export
vis.immunr_rare_prop <- function(.data, .by = NA, .meta = NA, .errorbars = c(0.025, 0.975), .errorbars.off = FALSE, .stack = NA, .points = TRUE, .test = TRUE, .sort = FALSE, .x_axis_adjust = FALSE, .x_axis_reorder = FALSE,...) {
  tmp <- .data
  if (is.null(dim(tmp))) {
    tmp <- t(as.matrix(tmp))
    .data <- t(as.matrix(.data))
  ...
  p <- vis_bar(res,
    .by = .by, .meta = .meta, .x_axis_adjust = .x_axis_adjust, .x_axis_reorder = .x_axis_reorder,
    .errorbars = .errorbars, .errorbars.off = .errorbars.off, .stack = .stack,
...
#' @export
vis_bar <- function(.data, .by = NA, .meta = NA, .errorbars = c(0.025, 0.975), .errorbars.off = FALSE, 
                    .stack = FALSE, .sort = FALSE, .x_axis_adjust = FALSE, .x_axis_reorder = FALSE, .points = TRUE, .test = TRUE, 
                    .signif.label.size = 3.5, .errorbar.width = 0.2, .defgroupby = "Sample", .grouping.var = "Group",
                    .labs = c("X", "Y"), .title = "Barplot (.title argument)",
                    .subtitle = "Subtitle (.subtitle argument)",
                    .legend = NA, .leg.title = "Legend (.leg.title argument)", .legend.pos = "right",
                    .rotate_x = 90) {
  
  level_order <- c('PRE_MD0001_TCRB', 'POST_MD0001_TCRB', 'PRE_MD0003_TCRB', 'POST_MD0003_TCRB', 'PRE_MD0005_TCRB', 'POST_MD0005_TCRB','PRE_MD0006_TCRB', 'POST_MD0006_TCRB', 'PRE_MD0007_TCRB', 'POST_MD0007_TCRB', 'PRE_MD0009_TCRB', 'POST_MD0009_TCRB', 'PRE_MD0015_TCRB', 'POST_MD0015_TCRB','PRE_MD0017_TCRB', 'POST_MD0017_TCRB', 'PRE_MD0018_TCRB', 'POST_MD0018_TCRB', 'PRE_MD0019_TCRB', 'POST_MD0019_TCRB', 'PRE_MD0020_TCRB', 'POST_MD0020_TCRB','PRE_MD0022_TCRB', 'POST_MD0022_TCRB', 'PRE_MD0023_TCRB', 'POST_MD0023_TCRB', 'PRE_MD0024_TCRB', 'POST_MD0024_TCRB', 'PRE_MD0026_TCRB', 'POST_MD0026_TCRB', 'PRE_MD0027_TCRB', 'POST_MD0027_TCRB', 'PRE_MD0029_TCRB', 'POST_MD0029_TCRB',	'PRE_MD0030_TCRB', 'POST_MD0030_TCRB', 'PRE_MD0031_TCRB', 'POST_MD0031_TCRB', 'PRE_MD0032_TCRB', 'POST_MD0032_TCRB', 'PRE_MD0033_TCRB', 'POST_MD0033_TCRB', 'PRE_MD0034_TCRB', 'POST_MD0034_TCRB', 'PRE_MD0035_TCRB', 'POST_MD0035_TCRB', 'PRE_MD0036_TCRB', 'POST_MD0036_TCRB', 'PRE_MD0037_TCRB', 'POST_MD0037_TCRB', 'PRE_MD0038_TCRB', 'POST_MD0038_TCRB', 'PRE_MD0039_TCRB', 'POST_MD0039_TCRB', 'PRE_MD0042_TCRB', 'POST_MD0042_TCRB', 'PRE_MD0044_TCRB', 'POST_MD0044_TCRB', 'PRE_MD0045_TCRB', 'POST_MD0045_TCRB', 'PRE_MD0046_TCRB', 'POST_MD0046_TCRB', 'PRE_MD0047_TCRB', 'POST_MD0047_TCRB', 'PRE_MD0050_TCRB', 'POST_MD0050_TCRB', 'PRE_MD0052_TCRB', 'POST_MD0052_TCRB', 'PRE_MD0053_TCRB', 'POST_MD0053_TCRB', 'PRE_MD0054_TCRB', 'POST_MD0054_TCRB', 'PRE_MD0055_TCRB', 'POST_MD0055_TCRB', 'PRE_MD0058_TCRB', 'POST_MD0058_TCRB', 'PRE_MD0059_TCRB', 'POST_MD0059_TCRB', 'PRE_MD0060_TCRB', 'POST_MD0060_TCRB', 'PRE_MD0061_TCRB', 'POST_MD0061_TCRB', 'PRE_MD0062_TCRB', 'POST_MD0062_TCRB', 'PRE_MD0063_TCRB', 'POST_MD0063_TCRB', 'PRE_MD0064_TCRB', 'POST_MD0064_TCRB', 'PRE_MD0065_TCRB', 'POST_MD0065_TCRB', 'PRE_MD0067_TCRB', 'POST_MD0067_TCRB', 'PRE_MD0068_TCRB', 'POST_MD0068_TCRB', 'PRE_MD0069_TCRB', 'POST_MD0069_TCRB')
  ...
  if (group_res$is_grouped) {
    ...
    if (.stack) {
      ...
      if (.sort) {
        p <- ggplot() +
          geom_bar(aes(x = reorder(Sample, -Value), y = Value, fill = Grouping.var), data = .data, colour = "black", stat = "identity",
                   position = "stack")
      } else {
        p <- ggplot() +
          geom_bar(aes(x = Sample, y = Value, fill = Grouping.var), data = .data, colour = "black", stat = "identity",
                   position = "stack")
      }
      ...
      # if we need the bars to be sorted
      if(.sort) {
        # order by y-value
        p <- ggplot() +
          geom_bar(aes(x = reorder(Grouping.var, -Value), y = Value, fill = reorder(Grouping.var, -Value)), position = position_name, 
                   stat = "identity", data = .data, col = "black")
      } else {
        p <- ggplot() +
          geom_bar(aes(x = Grouping.var, y = Value, fill = Sample), position = position_name, stat = "identity", 
                   data = .data, col = "black")
      }
  ...
  if (.x_axis_adjust) {
    p <- p + theme_pubr(legend = .legend.pos) +
      labs(x = .labs[1], y = .labs[2], title = .title, subtitle = .subtitle, fill = .leg.title) +
      rotate_x_text() + theme_cleveland2() +
      theme(axis.text.x = element_text(size = rel(0.65))) # reduce text size for x-label
  } else {
    p <- p + theme_pubr(legend = .legend.pos) +
      labs(x = .labs[1], y = .labs[2], title = .title, subtitle = .subtitle, fill = .leg.title) +
      rotate_x_text() + theme_cleveland2()
  ...
  if (.x_axis_reorder) {
    p <- p + scale_x_discrete(limits = level_order)
  }
...
#' vis(dv)
#' @export
vis.immunr_chao1 <- function(.data, .by = NA, .meta = NA, .errorbars = c(0.025, 0.975), .errorbars.off = FALSE, 
                             .points = TRUE, .test = TRUE, .signif.label.size = 3.5, .sort = FALSE, .x_axis_adjust = FALSE,...) {
  .data <- data.frame(Sample = row.names(.data), Value = .data[, 1])

  vis_bar(
    .data = .data, .by = .by, .meta = .meta, .sort = .sort, .x_axis_adjust = .x_axis_adjust,
    .errorbars = .errorbars, .errorbars.off = .errorbars.off, .stack = FALSE,
    .points = .points, .test = .test, .signif.label.size = .signif.label.size,
    .defgroupby = "Sample", .grouping.var = "Group",
    .labs = c(NA, "Chao1"),
...
#' @export
vis.immunr_div <- function(.data, .by = NA, .meta = NA, .sort = FALSE, .x_axis_adjust = FALSE,
...
#' @export
vis.immunr_exp_vol <- function(.data, .by = NA, .meta = NA, .sort = FALSE, .x_axis_adjust = FALSE,
                               .errorbars = c(0.025, 0.975), .errorbars.off = FALSE,
...
#' @export
vis.immunr_exp_len <- function(.data, .by = NA, .meta = NA, .sort = FALSE, .x_axis_adjust = FALSE,
                               .errorbars = c(0.025, 0.975), .errorbars.off = FALSE,
                               .points = TRUE, .test = TRUE,
                               .signif.label.size = 3.5, ...) {
